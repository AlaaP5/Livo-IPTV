...
const items = ref<ISeasonEpisodeResponse[]>([]);
...
const headers: DataTableHeader[] = [
  ...
  { title: "Season ID", key: "seasonId", align: "center" },
...
const selectedEpisode = ref<ISeasonEpisodeResponse | null>(null);

const openEditDialog = (item: ISeasonEpisodeResponse) => {
...
async function fetchSeasonEpisodes() {
  ...
  try {
    const response = await tvProgramService.getSeasonEpisodes(credentials);
