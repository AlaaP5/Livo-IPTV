...
const credentials = reactive<IFilterSectionRequest>({
  ...
  publish: "",
  title: "",
  contentType: ContentType.TV_PROGRAMS,
  sectionPage: MobilePage.TV_PROGRAMS,
});
...
function goToViewSectionTvs(item: ISectionResponse) {
  router.push({
...
<template>
  <v-container>
    <v-row justify="center">
      <v-col cols="12" style="max-width: 900px">
        <div class="title">Tv Program Sections</div>
      </v-col>
    </v-row>
  </v-container>
  ...
  <CreateSection
    ...
    :mobile-page="MobilePage.TV_PROGRAMS"
    :content-type="ContentType.TV_PROGRAMS"
    @created="onCreated"
  />
