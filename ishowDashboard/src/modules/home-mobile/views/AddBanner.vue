...
const save = async () => {
  ...
  try {
    switch (tab.value) {
      case "movie":
        console.log(await homeService.addMovieBanner(movieId.value));
        break;

      case "series":
        console.log(await homeService.addSeriesBanner(seriesId.value));
        break;

      case "channel":
        await homeService.addChannelBanner(channelId.value);
        break;

      case "tv":
        await homeService.addTvProgramBanner(tvProgramId.value);
        break;

      case "clip":
        await homeService.addClipBanner(clipId.value);
        break;
    }
