...
const items = ref<IHomeBannerResponse[]>([]);
const totalItems = ref(0);

const addBannerDialog = ref(false);
const removeDialog = ref(false);

const selectedBanner = ref<IHomeBannerResponse | null>(null);
...
const openRemoveDialog = (item: IHomeBannerResponse) => {
  ...
  <v-container>
    <v-row justify="center">
      <v-col cols="12" style="max-width: 900px">
        <div class="title">Home Banner List</div>
      </v-col>
    </v-row>
  </v-container>
