...
function goToViewSectionMovies(item: ISectionResponse) {
  router.push({
...
<template>
  <v-container>
    <v-row justify="center">
      <v-col cols="12" style="max-width: 900px">
        <div class="title">Movie Sections</div>
      </v-col>
    </v-row>
  </v-container>
  ...
  <CreateSection
    ...
    :mobile-page="MobilePage.MOVIES"
    :content-type="ContentType.MOVIES"
    @created="onCreated"
  />
              ...
              >
                <template #actions="{ item }">
                  ...
                  <v-btn
                    ...
                    color="primary"
                    class="ml-2"
                    @click="goToViewSectionMovies(item)"
                  >
                    view movies
                  </v-btn>
                </template>
