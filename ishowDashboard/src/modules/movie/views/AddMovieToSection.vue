...
import type { IAddMovieToSectionRequest } from "../types/movie-request";
import type {
  ILookupRequest,
  ILookupResponse,
...
async function getMovies() {
  movies.value = await lookupService.getAllMovies(lookupMovieRequest);
}

async function confirm() {

  await movieService.addMovieToSection(credentials);
