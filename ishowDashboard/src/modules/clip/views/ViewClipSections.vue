...
const credentials = reactive<IFilterSectionRequest>({
  ...
  publish: "",
  title: "",
  contentType: ContentType.CLIPS,
  sectionPage: MobilePage.CLIPS,
});
...
function goToViewSectionClips(item: ISectionResponse) {
  router.push({
...
<template>
  <v-container>
    <v-row justify="center">
      <v-col cols="12" style="max-width: 900px">
        <div class="title">Clip Sections</div>
      </v-col>
    </v-row>
  </v-container>
  ...
  <CreateSection
    ...
    :mobile-page="MobilePage.CLIPS"
    :content-type="ContentType.CLIPS"
    @created="onCreated"
  />
              ...
              >
                <template #actions="{ item }">
                  ...
                  <v-btn
                    ...
                    color="primary"
                    class="ml-2"
                    @click="goToViewSectionClips(item)"
                  >
                    view clips
                  </v-btn>
                </template>
