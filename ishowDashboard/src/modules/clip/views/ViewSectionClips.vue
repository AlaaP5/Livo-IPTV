...
import type { IClipSectionRequest } from "../types/clip-request";
...
async function handleFilters() {
  const response = await clipService.viewSectionClips(credentials);
...
<template>
  ...
  <AddClipToSection :section-id="credentials.sectionId" v-model="addMovieDialog" @added="onAdded" />
