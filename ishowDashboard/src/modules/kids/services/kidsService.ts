...
class KidsService {
    ...
    try {
      ...
      >(
        ROUTES_ENUM.ISHOW +
          ...
          ROUTES_ENUM.KIDS.VIEW_SECTION_MOVIES,
        HttpMethod.GET,
        payload,
      );
    ...
    try {
      ...
      const response = await useApi<IAddMovieToSectionRequest, null>(
        ROUTES_ENUM.ISHOW +
          ROUTES_ENUM.ADMIN +
          ROUTES_ENUM.KIDS.BASE +
          ROUTES_ENUM.KIDS.ADD_MOVIE_TO_SECTION,
        HttpMethod.GET,
        payload,
      );
      console.log(response);
    ...
    try {
      ...
      const response = await useApi<IRemoveMovieFromSectionRequest, null>(
        ROUTES_ENUM.ISHOW +
          ROUTES_ENUM.ADMIN +
          ROUTES_ENUM.KIDS.BASE +
          ROUTES_ENUM.KIDS.REMOVE_MOVIE_FROM_SECTION,
        HttpMethod.GET,
        payload,
      );
      console.log(response);
  ...
  async changeStatusMovie(payload: IAddMovieToSectionRequest) {
    ...
    try {
      const url = `${ROUTES_ENUM.ISHOW}${ROUTES_ENUM.ADMIN}${ROUTES_ENUM.KIDS.BASE}${ROUTES_ENUM.KIDS.MOVIE_SECTION_IS_TOP}?sectionId=${payload.sectionId}&movieId=${payload.movieId}&isTop=${payload.isTop}`;
    ...
    try {
      ...
      >(
        ROUTES_ENUM.ISHOW +
          ROUTES_ENUM.ADMIN +
          ROUTES_ENUM.KIDS.BASE +
          ROUTES_ENUM.KIDS.VIEW_SECTION_SERIES,
        HttpMethod.GET,
        payload,
      );
    ...
    try {
      ...
      const response = await useApi<IAddSeriesToSectionRequest, null>(
        ROUTES_ENUM.ISHOW +
          ROUTES_ENUM.ADMIN +
          ROUTES_ENUM.KIDS.BASE +
          ROUTES_ENUM.KIDS.ADD_SERIES_TO_SECTION,
        HttpMethod.GET,
        payload,
      );
      console.log(response);
    ...
    try {
      ...
      const response = await useApi<IRemoveSeriesFromSectionRequest, null>(
        ROUTES_ENUM.ISHOW +
          ROUTES_ENUM.ADMIN +
          ROUTES_ENUM.KIDS.BASE +
          ROUTES_ENUM.KIDS.REMOVE_SERIES_FROM_SECTION,
        HttpMethod.GET,
        payload,
      );
      console.log(response);
  ...
  async changeStatusSeries(payload: IAddSeriesToSectionRequest) {
    ...
    try {
      const url = `${ROUTES_ENUM.ISHOW}${ROUTES_ENUM.ADMIN}${ROUTES_ENUM.KIDS.BASE}${ROUTES_ENUM.KIDS.SERIES_SECTION_IS_TOP}?sectionId=${payload.sectionId}&seriesId=${payload.seriesId}&isTop=${payload.isTop}`;
    ...
    try {
      ...
      >(
        ROUTES_ENUM.ISHOW +
          ROUTES_ENUM.ADMIN +
          ROUTES_ENUM.KIDS.BASE +
          ROUTES_ENUM.KIDS.VIEW_SECTION_CLIP,
        HttpMethod.GET,
        payload,
      );
    ...
    try {
      ...
      const response = await useApi<IAddClipToSectionRequest, null>(
        ROUTES_ENUM.ISHOW +
          ROUTES_ENUM.ADMIN +
          ROUTES_ENUM.KIDS.BASE +
          ROUTES_ENUM.KIDS.ADD_CLIP_TO_SECTION,
        HttpMethod.GET,
        payload,
      );
      console.log(response);
    ...
    try {
      ...
      const response = await useApi<IRemoveClipFromSectionRequest, null>(
        ROUTES_ENUM.ISHOW +
          ROUTES_ENUM.ADMIN +
          ROUTES_ENUM.KIDS.BASE +
          ROUTES_ENUM.KIDS.REMOVE_CLIP_FROM_SECTION,
        HttpMethod.GET,
        payload,
      );
      console.log(response);
  ...
  async changeStatusClip(payload: IAddClipToSectionRequest) {
    ...
    try {
      const url = `${ROUTES_ENUM.ISHOW}${ROUTES_ENUM.ADMIN}${ROUTES_ENUM.KIDS.BASE}${ROUTES_ENUM.KIDS.CLIP_SECTION_IS_TOP}?sectionId=${payload.sectionId}&clipId=${payload.clipId}&isTop=${payload.isTop}`;
    ...
    try {
      ...
      >(
        ROUTES_ENUM.ISHOW +
          ROUTES_ENUM.ADMIN +
          ROUTES_ENUM.KIDS.BASE +
          ROUTES_ENUM.KIDS.VIEW_SECTION_CHANNELS,
        HttpMethod.GET,
        payload,
      );
    ...
    try {
      ...
      const response = await useApi<IAddChannelToSectionRequest, null>(
        ROUTES_ENUM.ISHOW +
          ROUTES_ENUM.ADMIN +
          ROUTES_ENUM.KIDS.BASE +
          ROUTES_ENUM.KIDS.ADD_CHANNEL_TO_SECTION,
        HttpMethod.GET,
        payload,
      );
      console.log(response);
    ...
    try {
      ...
      const response = await useApi<IRemoveChannelFromSectionRequest, null>(
        ROUTES_ENUM.ISHOW +
          ROUTES_ENUM.ADMIN +
          ROUTES_ENUM.KIDS.BASE +
          ROUTES_ENUM.KIDS.REMOVE_CHANNEL_FROM_SECTION,
        HttpMethod.GET,
        payload,
      );
      console.log(response);
  ...
  async changeStatusChannel(payload: IAddChannelToSectionRequest) {
    ...
    try {
      const url = `${ROUTES_ENUM.ISHOW}${ROUTES_ENUM.ADMIN}${ROUTES_ENUM.KIDS.BASE}${ROUTES_ENUM.KIDS.CHANNEL_SECTION_IS_TOP}?sectionId=${payload.sectionId}&channelId=${payload.channelId}&isTop=${payload.isTop}`;
    ...
    try {
      ...
      const response = await useApi<ITvSectionRequest, ISectionTvResponse[]>(
        ROUTES_ENUM.ISHOW +
          ROUTES_ENUM.ADMIN +
          ROUTES_ENUM.KIDS.BASE +
          ROUTES_ENUM.KIDS.VIEW_SECTION_TVS,
        HttpMethod.GET,
        payload,
      );
    ...
    try {
      ...
      const response = await useApi<IAddTvToSectionRequest, null>(
        ROUTES_ENUM.ISHOW +
          ROUTES_ENUM.ADMIN +
          ROUTES_ENUM.KIDS.BASE +
          ROUTES_ENUM.KIDS.ADD_TV_TO_SECTION,
        HttpMethod.GET,
        payload,
      );
      console.log(response);
    ...
    try {
      ...
      const response = await useApi<IRemoveTvFromSectionRequest, null>(
        ROUTES_ENUM.ISHOW +
          ROUTES_ENUM.ADMIN +
          ROUTES_ENUM.KIDS.BASE +
          ROUTES_ENUM.KIDS.REMOVE_TV_FROM_SECTION,
        HttpMethod.GET,
        payload,
      );
      console.log(response);
  ...
  async changeStatusTv(payload: IAddTvToSectionRequest) {
    ...
    try {
      const url = `${ROUTES_ENUM.ISHOW}${ROUTES_ENUM.ADMIN}${ROUTES_ENUM.KIDS.BASE}${ROUTES_ENUM.KIDS.TV_SECTION_IS_TOP}?sectionId=${payload.sectionId}&tvProgramId=${payload.tvProgramId}&isTop=${payload.isTop}`;
  ...
  async addMovieBanner(movieId: string) {
    ...
    try {
      return await useApi(
        `${ROUTES_ENUM.ISHOW}${ROUTES_ENUM.ADMIN}${ROUTES_ENUM.KIDS.BASE}${ROUTES_ENUM.KIDS.BANNER}${ROUTES_ENUM.KIDS.MOVIE_ADD}?movieId=${movieId}`,
        HttpMethod.POST,
        null,
      );
    } finally {
  ...
  async addSeriesBanner(seriesId: string) {
    ...
    try {
      return await useApi(
        `${ROUTES_ENUM.ISHOW}${ROUTES_ENUM.ADMIN}${ROUTES_ENUM.KIDS.BASE}${ROUTES_ENUM.KIDS.BANNER}${ROUTES_ENUM.KIDS.SERIES_ADD}?seriesId=${seriesId}`,
        HttpMethod.POST,
        null,
      );
    } finally {
  ...
  async addChannelBanner(channelId: string) {
    ...
    try {
      return await useApi(
        `${ROUTES_ENUM.ISHOW}${ROUTES_ENUM.ADMIN}${ROUTES_ENUM.KIDS.BASE}${ROUTES_ENUM.KIDS.BANNER}${ROUTES_ENUM.KIDS.CHANNEL_ADD}?channelId=${channelId}`,
        HttpMethod.POST,
        null,
      );
    } finally {
  ...
  async addTvProgramBanner(tvProgramId: string) {
    ...
    try {
      return await useApi(
        `${ROUTES_ENUM.ISHOW}${ROUTES_ENUM.ADMIN}${ROUTES_ENUM.KIDS.BASE}${ROUTES_ENUM.KIDS.BANNER}${ROUTES_ENUM.KIDS.TV_PROGRAM_ADD}?tvProgramId=${tvProgramId}`,
        HttpMethod.POST,
        null,
      );
    } finally {
  ...
  async addClipBanner(clipId: string) {
    ...
    try {
      return await useApi(
        `${ROUTES_ENUM.ISHOW}${ROUTES_ENUM.ADMIN}${ROUTES_ENUM.KIDS.BASE}${ROUTES_ENUM.KIDS.BANNER}${ROUTES_ENUM.KIDS.CLIP_ADD}?clipId=${clipId}`,
        HttpMethod.POST,
        null,
      );
    } finally {
  ...
  async getBannerList() {
    ...
    try {
      const response = await useApi<null, IKidsBannerResponse[]>(
        ROUTES_ENUM.ISHOW +
          ROUTES_ENUM.ADMIN +
          ROUTES_ENUM.KIDS.BASE +
  ...
  async removeBanner(contentId: string, contentType: string) {
    ...
    try {
      const response = await useApi<null, null>(
        `${ROUTES_ENUM.ISHOW}${ROUTES_ENUM.ADMIN}${ROUTES_ENUM.KIDS.BASE}${ROUTES_ENUM.KIDS.BANNER}${ROUTES_ENUM.KIDS.BANNER_REMOVE}?contentId=${contentId}&contentType=${contentType}`,
        HttpMethod.DELETE,
        null,
      );
