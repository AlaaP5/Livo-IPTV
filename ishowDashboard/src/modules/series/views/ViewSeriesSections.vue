...
function goToViewSectionSeries(item: ISectionResponse) {
  router.push({
  ...
  <v-container>
    <v-row justify="center">
      <v-col cols="12" style="max-width: 900px">
        <div class="title">Series Sections</div>
      </v-col>
    </v-row>
  </v-container>
              ...
              >
                <template #actions="{ item }">
                  ...
                  <v-btn
                    ...
                    color="primary"
                    class="ml-2"
                    @click="goToViewSectionSeries(item)"
                  >
                    view series
                  </v-btn>
                </template>
